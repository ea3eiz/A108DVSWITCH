...
# Pone Enable=1 en [Dstar]
sed -i "40c Enable=1" /opt/MMDVM_Bridge/MMDVM_Bridge.ini
sed -i "40c Enable=1" /opt/MMDVM_Bridge/MMDVM_Bridge_FCS.ini
sed -i "40c Enable=1" /opt/MMDVM_Bridge/brandmeister_esp.ini
sed -i "40c Enable=1" /opt/MMDVM_Bridge/dmrplus.ini
sed -i "40c Enable=1" /opt/MMDVM_Bridge/especial.ini
