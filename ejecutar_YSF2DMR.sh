...
cd /home/pi/YSF2DMR
xterm -geometry 88x6+1274+665 -bg black -fg orange -fa ‘verdana’ -fs 9x -T CONSOLA_YSF2DMR -e ./YSF2DMR YSF2DMR.ini &  

sleep 2
cd /home/pi/MMDVMHost
#/home/pi/A108/./qt_info_ysf2dmr & sudo ./MMDVMFUSION MMDVMFUSION.ini
xterm -geometry 88x9+1274+787 -bg black -fg orange -fa ‘verdana’ -fs 9x -T CONSOLA_MMDVMFUSION -e sudo ./MMDVMFUSION MMDVMFUSION.ini
